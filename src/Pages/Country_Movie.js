...
import { handleGetPageCountry, handleSavemovie } from '../Service';
function Country_Movie() {
    ...
    useEffect(() => {
        const CallPageCountry = async () => {
            const data = await handleGetPageCountry(slug_country, Page)
