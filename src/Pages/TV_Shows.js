...
import { handleGetPageTvShows, handleSavemovie } from '../Service';
function Series_Movie() {
    ...
    useEffect(() => {
        const CallPageTvShows = async () => {
            const data = await handleGetPageTvShows(Page)
            ...
            {Time_spinner ? <div className='flex justify-center h-screen items-center'>
                ...
                <div className='w-[97%]'>
                    <div className='flex justify-between items-center'>
                        <h2 className='uppercase mt-10 font-bold text-white pl-[75px] flex gap-1'> Danh Sách Tất Cả TV Shows </h2>
