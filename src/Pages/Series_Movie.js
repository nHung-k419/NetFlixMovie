...
function Series_Movie() {
    ...
    let numberPage = []
    useEffect(() => {
        fetch(`https://phimapi.com/v1/api/danh-sach/phim-bo?page=${Page}&limit=18`)
            .then(res => res.json())
            .then(data => {
            ...
            {Time_spinner ? <div className='flex justify-center h-screen items-center'>
                ...
                <div className='w-[97%]'>
                    <div className='flex justify-between items-center'>
                        <h2 className='uppercase mt-10 font-bold text-white pl-[75px] flex gap-1'> Danh Sách Tất Cả Phim Bộ</h2>
