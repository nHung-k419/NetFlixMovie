...
import { handleGetPageAnime, handleSavemovie } from '../Service';
function Anime_Movie() {
    ...
    useEffect(() => {
        const CallPageAnime = async () => {
            const data = await handleGetPageAnime(Page)
